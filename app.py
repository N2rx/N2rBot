...
from utils import pypresence as presence
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle("N2r Bot")
        ...
        self.accounts_tab = QtWidgets.QWidget(self.sidebar)
        self.accounts_tab.setGeometry(QtCore.QRect(0, 265, 60, 45))
        self.accounts_tab.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.accounts_tab.setStyleSheet("background-color: transparent;border: none;")
        self.accounts_active_tab = QtWidgets.QWidget(self.accounts_tab)
        self.accounts_active_tab.setGeometry(QtCore.QRect(0, 0, 4, 45))
        self.accounts_active_tab.setStyleSheet("background-color: transparent;border: none;")
        self.accounts_active_tab.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.accounts_icon = QtWidgets.QLabel(self.accounts_tab)
        self.accounts_icon.setGeometry(QtCore.QRect(21, 13, 20, 20))
        self.accounts_icon.setStyleSheet("border: none;")
        self.accounts_icon.setText("")
        self.accounts_icon.setPixmap(QtGui.QPixmap("images/accounts.png"))
        self.accounts_icon.setScaledContents(True)
        self.accounts_icon.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.logo.setText("")
        self.logo.setPixmap(QtGui.QPixmap("images/n2r.png"))
        ...
        self.createdialog.setWindowIcon(QtGui.QIcon("images/n2r.png"))
        ...
        self.accountspage = AccountsPage(self.centralwidget)
        self.accountspage.hide()
    ...
    def set_functions(self):
        ...
        self.accounts_tab.mousePressEvent = lambda event: self.change_page(event, "accounts")
    ...
    def create_task(self):
        ...
        account = self.createdialog.account_box.currentText()
        ...
        end_less = self.createdialog.endless_checkbox.isChecked()
        cookie_name = self.createdialog.cookiename_edit.text()
        if site != "Site" and product != "" and profile != "Profile" and monitor_delay != "" and error_delay != "" and account != "Account":
...
if __name__ == "__main__":
    ...
    ui = MainWindow()
    ui.setWindowIcon(QtGui.QIcon("images/n2r.png"))
