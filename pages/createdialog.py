...
class CreateDialog(QtWidgets.QDialog):
    ...
    def setupUi(self, CreateDialog):
        ...
        CreateDialog.setFixedSize(647, 190)
        ...
        self.background.setStyleSheet("background-color: {};".format(globalStyles["backgroundDark"]))
        font = QtGui.QFont()
        ...
        self.site_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.input_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.account_box.setGeometry(QtCore.QRect(450, 120, 151, 21))
        self.account_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.addtask_btn.setGeometry(QtCore.QRect(50, 140, 151, 32))
        ...
        self.endless_checkbox = QtWidgets.QCheckBox(self.background)
        self.endless_checkbox.setGeometry(QtCore.QRect(250, 100, 87, 20))
        font = QtGui.QFont()
        font.setPointSize(13) if platform.system() == "Darwin" else font.setPointSize(13*.75)
        font.setFamily("Roboto")
        self.endless_checkbox.setFont(font)
        self.endless_checkbox.setStyleSheet("color: #FFFFFF;")
        self.endless_checkbox.setText("Endless Buy")
        ...
        self.price_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.taskcount_spinbox.setGeometry(QtCore.QRect(230, 145, 41, 21))
        ...
        self.cookiename_edit = QtWidgets.QLineEdit(self.background)
        self.cookiename_edit.setGeometry(QtCore.QRect(310, 144, 100, 21))
        self.cookiename_edit.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.cookiename_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        self.cookiename_edit.setAttribute(QtCore.Qt.WA_MacShowFocusRect, 0)
        self.cookiename_edit.setPlaceholderText("Cookie name")
        self.cookiename_edit.setFont(font)
        self.cookiename_edit.textEdited.connect(self.autofill)

        self.site_box.addItem("Newegg Saudi")
        self.site_box.addItem("Newegg combo Saudi")

        QtCore.QMetaObject.connectSlotsByName(CreateDialog)
    def autofill(self):
        if "newegg saudi" in self.input_edit.text():
            self.site_box.setCurrentIndex(self.site_box.findText("NewEgg"))
        elif "newegg combo saudi" in self.input_edit.text():
            self.site_box.setCurrentIndex(self.site_box.findText("NewEggcombo"))
    ...
    def load_data(self, task_tab):
        ...
        self.account_box.setCurrentText(task_tab.account)
        ...
        self.endless_checkbox.setChecked(task_tab.end_less)
        self.cookiename_edit.setText(task_tab.cookie_name)
