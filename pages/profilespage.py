...
class ProfilesPage(QtWidgets.QWidget):
    ...
    def setupUi(self, profilespage):
        ...
        self.shipping_card.setStyleSheet("background-color: {};border-radius: 20px;border: 1px solid #2e2d2d;".format(globalStyles["backgroundLight"]))
        ...
        self.shipping_fname_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.shipping_lname_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.shipping_email_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.shipping_phone_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.shipping_address1_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.shipping_address2_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.shipping_city_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.shipping_zipcode_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.shipping_state_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.shipping_country_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        self.shipping_country_box.addItem("Country")
        self.shipping_country_box.addItem("United States")
        self.shipping_country_box.addItem("Saudi Arabia")
        ...
        self.billing_card.setStyleSheet("background-color: {};border-radius: 20px;border: 1px solid #2e2d2d;".format(globalStyles["backgroundLight"]))
        ...
        self.billing_fname_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.billing_lname_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.billing_email_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.billing_phone_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.billing_address1_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.billing_address2_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.billing_city_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.billing_zipcode_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.billing_state_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.billing_country_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        self.billing_country_box.addItem("Country")
        self.billing_country_box.addItem("United States")
        self.billing_country_box.addItem("Saudi Arabia")
        ...
        self.cardnumber_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.cardcvv_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.cardtype_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.cardmonth_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.cardyear_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.profilename_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.loadprofile_box.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        ...
        self.set_data()
        self.nationalid_edit = QtWidgets.QLineEdit(self.tasks_card_3)
        self.nationalid_edit.setAttribute(QtCore.Qt.WA_MacShowFocusRect, 0)
        self.nationalid_edit.setGeometry(QtCore.QRect(30, 390, 253, 31))
        font = QtGui.QFont()
        font.setPointSize(13) if platform.system() == "Darwin" else font.setPointSize(13*.75)
        font.setFamily("Roboto")
        self.nationalid_edit.setFont(font)
        self.nationalid_edit.setStyleSheet("outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(globalStyles["primary"]))
        self.nationalid_edit.setPlaceholderText("National ID")
    ...
    def load_profile(self):
        ...
        if p is not None:
            ...
            self.nationalid_edit.setText(p["nationalid"])
        return
    def save_profile(self):
        ...
        profile_data={
            ...
            "nationalid": self.nationalid_edit.text()
        }      
        profiles = return_data("./data/profiles.json")
        for p in profiles:
        ...
        if self.loadprofile_box.findText(profile_name) == -1:
            self.loadprofile_box.addItem(profile_name)
            self.parent().parent().createdialog.profile_box.addItem(profile_name)
        QtWidgets.QMessageBox.information(self, "N2r Bot", "Saved Profile")
    ...
    def delete_profile(self):
        ...
        self.nationalid_edit.setText("")
        QtWidgets.QMessageBox.information(self, "N2r Bot", "Deleted Profile")
